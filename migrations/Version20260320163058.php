 ...
 */
final class Version20260320163058 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE character ADD COLUMN updated_at DATETIME DEFAULT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TEMPORARY TABLE __temp__character AS SELECT id, name, level, strength, dexterity, constitution, inteligence, wisdom, charisma, health_points, image, user_id, race_id, class_id FROM character');
        ...
        $this->addSql('INSERT INTO character (id, name, level, strength, dexterity, constitution, inteligence, wisdom, charisma, health_points, image, user_id, race_id, class_id) SELECT id, name, level, strength, dexterity, constitution, inteligence, wisdom, charisma, health_points, image, user_id, race_id, class_id FROM __temp__character');
